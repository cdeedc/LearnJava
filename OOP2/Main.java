...
public class Main {
    public static void main(String[] args) {
        ...
        // Oras
        adr = "Str. Vasile Parvan";
        Scoala scoala1 = new Scoala(profs, clase, prof, adr, "Colegiul National \"Alexandru Odobescu\"");

        Scoala[] scoli = { scoala, scoala1 };
        Oras oras = new Oras(scoli, "Pitesti");
        oras.afisare();
    }
}